...
aaa = subprocess.run('bash -c "ffmpeg -t 19800 -i "http://pull-flv-l26.douyincdn.com/stage/stream-689590783250268299_or4.flv?expire=6484347c&sign=cfc2b1fde60f391b4b808d88a87bfe99" aaa.mp4"',shell=True)
